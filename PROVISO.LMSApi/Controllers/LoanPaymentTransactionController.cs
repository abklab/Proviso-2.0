...
namespace PROVISO.LMSApi.Controllers
{
...

    {
        ...
        public IHttpActionResult PostByMomoNumber([FromBody]MomoTransaction momotransaction)
        {
            ...
            {
                services.LogTransaction(momotransaction, "Invalid Momo number");
            ...
            if (!isvalid)
            {
                services.LogTransaction(momotransaction, "Invalid Reference Number");
            ...
            services.LogTransaction(momotransaction, response);
            return Ok(response);
        }
